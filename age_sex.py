...
cases_age_sex['Rango_edad'] = cases_age_sex['Rango_edad'].replace(
    '100 y +', '90 y +')
cases_age_sex['Rango_edad'] = cases_age_sex['Rango_edad'].replace(
    '90-99', '90 y +')

data['cases_age'] = cases_age_sex[[
    'Rango_edad', 'Sexo', 'Casos_confirmados']].copy()
data['cases_age'] = to_json(
    data['cases_age'], ['Rango_edad', 'Sexo'], ['Casos_confirmados'])

data['hospitalizations_age'] = cases_age_sex[[
    'Rango_edad', 'Sexo', 'Hospitalizados']].copy()
data['hospitalizations_age'] = to_json(data['hospitalizations_age'], [
                                       'Rango_edad', 'Sexo'], ['Hospitalizados'])

data['uci_age'] = cases_age_sex[['Rango_edad', 'Sexo', 'Ingresos_uci']].copy()
data['uci_age'] = to_json(
    data['uci_age'], ['Rango_edad', 'Sexo'], ['Ingresos_uci'])

data['deceased_age'] = cases_age_sex[['Rango_edad', 'Sexo', 'Fallecidos']].copy()
data['deceased_age'] = to_json(
    data['deceased_age'], ['Rango_edad', 'Sexo'], ['Fallecidos'])
